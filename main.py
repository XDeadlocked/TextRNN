...
def main():
    ...
    parse.add_argument("--do_cnn",default=False, action="store_true", help="Whether to run training.")
    parse.add_argument("--do_rnn", default=True, action="store_true", help="Whether to run training.")
    parse.add_argument("--do_avg",default=False, action="store_true", help="Whether to run training.")
